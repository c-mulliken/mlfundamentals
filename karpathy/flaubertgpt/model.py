...
class BigramLanguageModel(nn.Module):
    ...
    def __init__(self, vocab_size, n_layer, n_head, n_embd, block_size, dropout, device):
        super().__init__()
        self.device=device
        self.block_size=block_size
        self.token_embedding_table = nn.Embedding(vocab_size, n_embd)
        self.position_embedding_table = nn.Embedding(block_size, n_embd)
        self.blocks = nn.Sequential(*[Block(n_embd, n_head=n_head, block_size=block_size,
...
class MultiHeadAttention(nn.Module):
    def __init__(self, num_heads, n_embd, block_size, head_size, dropout):
        super().__init__()
